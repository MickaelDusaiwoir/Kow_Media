...
<section id="contests">
	...
	<ol class="progtrckr" data-progtrckr-steps="3">
		<li class="progtrckr-done">Choissisez vos cadeaux&nbsp;!<span class="step"><i class="icon-down-dir"></i></span></li><!--
		--><!--<li class="progtrckr-todo progressBar">
					Complétez le formulaire <strong>une seule fois&nbsp;!</strong>
				
				<section id="progress" class="tracker">
					<h1 class="no_show">Progression du formulaire</h1>
					<progress value="0" min="0" max="100"><span></span></progress>
					<p class="pourcentage step">
						<span>0</span>&nbsp;%
					</p>
				</section>
				<span class="no_show"></span>
			</li><!--
		--><!--<li class="progtrckr-todo progtrckr-las">Participez au concours&nbsp;!<span class="step"><i class="icon-down-dir"></i></span></li>
	</ol> -->
	...
	<section id="infosUser">
		<a href="#modal-formulaire" role="button" data-toggle="modal" title="Modifiez vos données" id="btn_infos">
			...
			<p>
				<!--<em>CP&nbsp;:</em>-->
				<span id="user_cp">75343</span>, <span id="user_ville">Paris</span>
			</p>
		</a>
		<footer>
